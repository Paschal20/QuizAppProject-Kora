...
const Quiz2: React.FC = () => {
  ...
  const questions: Question[] = [
    ...
    },
    {
      ...
      options: [" Microsoft", "Facebook (Meta)", "Amazon", "Google"],
      correctAnswer: 1,
    },
    {
      id: 3,
    ...
    },
    {
      id: 6,
      question:
        "What is the name of the best tech training institute in Nigeria?",
      options: ["The Curve.", "Aptech.", "NIIT.", "Kode10X."],
      correctAnswer: 3,
    },
    {
      id: 7,
      question: "What is the name of the only female instructor at Kode10X?",
      options: [
        "Miss Racheal.",
        "Miss Fathia.",
        "Miss Naomi.",
    ...
    },
    {
      id: 8,
      question:
        "What is the name of the of our Frontend instructor at Kode10X?",
      options: [
        "Master Raheem.",
        "Master Nelson.",
        "Master Victor.",
    ...
    },
    {
      id: 9,
      question:
        "How many interns are currently learning Full Stack Development at Kode10X?",
      options: ["25.", "10.", "None.", "30."],
      correctAnswer: 1,
    },
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 flex items-center justify-center p-4">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-12 max-w-lg w-full text-center">
          ...
          <p className="text-lg mb-2">
            Congratulations, <span className="font-semibold">{playerName}</span>
            !
          </p>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {currentQuestion.options.map((option, index) => {
              ...
              let btnClass =
                "option-btn px-4 py-3 rounded-lg border text-left font-medium transition-colors duration-300 ";
              if (selectedAnswer !== null) {
                if (isCorrect) {
                  btnClass +=
                    "bg-green-200 border-green-500 text-green-800 cursor-default";
                } else if (isSelected && !isCorrect) {
                  btnClass +=
                    "bg-red-200 border-red-500 text-red-800 cursor-default";
                } else {
                  btnClass +=
